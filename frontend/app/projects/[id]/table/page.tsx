                      ...
                      <div className="flex items-center justify-between gap-2">
                        ...
                        >
                          <button
                            ...
                            className="p-1 rounded text-[var(--ash-medium)] hover:text-[var(--ash-charcoal)] hover:bg-[var(--ash-gray)] transition-all"
                            title="Row actions"
                          >
                          ...
                          {rowMenu === fieldKey && (
                            <div className="absolute left-0 bottom-full mb-1 z-50 bg-white border border-[var(--ash-gray)] rounded-[var(--radius-md)] shadow-lg min-w-[130px] py-1 animate-fade-in">
                              <button
