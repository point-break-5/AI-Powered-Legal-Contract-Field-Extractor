...
import { Scale, Plus, Trash2, FolderOpen, ChevronLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[var(--ash-white)]">
      ...
      <header className="bg-white border-b border-[var(--ash-gray)] px-6 h-14 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <Link
            href="/"
            className="p-1 rounded-[var(--radius-sm)] text-[var(--ash-dark)] hover:text-[var(--accent-blue)] hover:bg-[var(--accent-blue)]/10 transition-colors mr-1"
            title="Back to home"
          >
            <ChevronLeft size={16} />
          </Link>
